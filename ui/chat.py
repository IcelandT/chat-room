...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(810, 580, 71, 41))
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/res/test/response-fill.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/text/test/document.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.on_line_user.setGeometry(QtCore.QRect(15, 40, 192, 591))
        ...
        self.on_line_user_nums = QtWidgets.QLabel(self.widget_3)
        self.on_line_user_nums.setGeometry(QtCore.QRect(90, 10, 31, 21))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(11)
        self.on_line_user_nums.setFont(font)
        self.on_line_user_nums.setStyleSheet("color: rgba(255, 255, 255, 255);")
        self.on_line_user_nums.setText("")
        self.on_line_user_nums.setObjectName("on_line_user_nums")
